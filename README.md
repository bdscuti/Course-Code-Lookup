...
When your university has been selected, it will set the chrome.sync.storage's selectedUniversity key to your selected university. This allows the selected university (along with selectedSubject, subjectSelectionMode) to persist even after you close the popup  
across sessions. 
